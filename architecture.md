...
This version is about providing a first service without overthinking the network, which is a topic for v1. The service(s) will provide Jellyfin and the *arr stack.
