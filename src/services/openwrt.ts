...
class OpenWRT implements Service {
  ...
  private readonly _URL =
    'https://fra1lxdmirror01.do.letsbuildthe.cloud/images/openwrt/23.05/amd64/default/20250504_11%3A57/rootfs.tar.xz';
  ...
  build() {
    ...
    const rootfs = new proxmox.download.File(
      ...
      {
        url: this._URL,
        fileName: `openwrt_${version}_${builddate}.tar.xz`,
